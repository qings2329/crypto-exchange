...
func TestSaveLoadMySQL(t *testing.T) {
	...
	_ = l.Deposit(70001, "USDT", 100000, "seed")
	_, _ = l.AddWithdrawAddress(70001, "USDT", "ETH", "0xsafe", "main")
	_ = l.ConfirmWithdrawAddress(70001, "USDT", "ETH", "0xsafe")
	if _, _, err := l.RequestWithdrawHold(70001, "USDT", 100, 0, "ETH", "0xsafe"); err != nil {
	...
	if avail, _, ok := l2.Balance(70001, "USDT"); !ok || avail < 99900-1e-9 {
